...
import { GetAllBusinessNearbyAction } from '../../../business-core/business-data/business.action';
import * as businessSelector from '../../../business-core/business-data/business.selector';
import { BizNearbyFilter, Business, Category, SubCategory } from '../../../business-core/business-data/business.model';
...
export class BusinessMapComponent implements OnInit {
  ...
  constructor(protected store: Store<fromRoot.AppState>, public _media: ObservableMedia) { }
