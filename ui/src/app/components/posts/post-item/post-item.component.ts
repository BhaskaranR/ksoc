...
import * as mycomments from '../../../core/post-data/post.selector';
...
import { Post, postComment, favoredBy, favor, Geotag } from '../../../core/post-data/post-model';
import { User } from '../../../core/user-data/user-model';
import { ObservableMedia, MediaChange } from '@angular/flex-layout';
import * as moment from 'moment';
import { ReactionsChangeEvent, ReactionsPosition } from '../../reactions';
...
export class PostItemComponent implements OnInit, OnDestroy {
  ...
  favoredBy: { userId: string, like: string }[] = []
  ...
  constructor(
    ...
    this.newcommentSubscription = this.store.select(mycomments.getMyNewPostComment).subscribe(comment => {
    ...
    this.newfavorSubscription = this.store.select(mycomments.getMyNewFavored).subscribe(favored => {
  ...
  ngOnInit() {
    ...
    if (this.geotag) {
      this.currentLoc.lat = parseFloat(this.geotag.coordinates.lat);
      this.currentLoc.long = parseFloat(this.geotag.coordinates.long);
    }
