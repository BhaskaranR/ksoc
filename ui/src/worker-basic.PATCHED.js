(function() {
    ...
    function copyExistingOrFetchOp(oldWorker, newWorker, url, cache) {
        var op = function() {
            return copyExistingCacheOp(oldWorker, newWorker, url, cache)()
                .then(function(res) {
                    if (!res) {
    ...
    function fetchFromCacheInstruction(worker, req, cache) {
        var op = function(next) {
            return worker.cache.load(cache, req)
    ...
    var Driver = (function() {
        ...
        Driver.prototype.transition = function(state) {
            ...
            if (state === DriverState.UPDATE_PENDING && this.pendingUpdateHash !== null) {
                this.updateListeners.forEach(function(id) {
                    return _this.sendToStream(id, {
                        type: 'pending',
        ...
        DynamicGroup.open = function(config, adapter, delegateCache, clock, strategies) {
            ...
            return cache
                ...
                .then(function(metadata) {
                    return metadata.reduce(function(acc, curr) {
        ...
        FreshnessStrategy.prototype.fetch = function(group, req, delegate) {
            ...
            return networkFetch
                .then(function(rse) {
                    ...
                    // PATCH: https://github.com/angular/mobile-toolkit/issues/179#issue-247374771
                    if (rse.response === null || !rse.response.ok) {
                        ...
                        return group
                            ...
                            .then(function(cacheRse) {
                                ...
                                var sideEffect = function() {
                                    return maybeRun(cacheRse.sideEffect)
